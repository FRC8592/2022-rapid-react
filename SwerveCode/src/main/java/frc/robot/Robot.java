...
//    climber           = new Climber();
  ...
  */
  ...
  public void teleopPeriodic(){
    ...
    translateX = (Math.pow(driverController.getLeftY(),3/2)  * Drivetrain.MAX_VELOCITY_METERS_PER_SECOND) * ConfigRun.TRANSLATE_POWER;        // X is forward Direction, Forward on Joystick is Y
    translateY = (Math.pow(driverController.getLeftX(),3/2)  * Drivetrain.MAX_VELOCITY_METERS_PER_SECOND) * ConfigRun.TRANSLATE_POWER;
