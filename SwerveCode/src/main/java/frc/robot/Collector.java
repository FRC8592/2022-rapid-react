...
public class Collector {
    ...
    // Intialize hardware
    //
    public Collector(FRCLogger logger) {
        this.logger = logger;
   ...
   /**
    ...
    public void ballControl(CollectorArmMM arm, Shooter shooter, Vision vision, Power powerMonitor) {
        ...
        logger.log(this, "TopBallLoaded", topBall);
        SmartDashboard.putBoolean("LineSensorBottom", bottomBall);
        logger.log(this, "BottomBallLoaded", bottomBall);
        SmartDashboard.putString("Collector State", collectorState.toString());
        logger.log(this, "CollecterStateString", collectorState.toString()); //We'll log the collector state as an int later, in the switch statement.
        SmartDashboard.putBoolean("Shoot Mode", shootMode);
        logger.log(this, "ShootMode", shootMode);
        SmartDashboard.putBoolean("Force Mode", forceShootMode);
        logger.log(this, "ForceShootMode", forceShootMode);
